...
import { HygoIconsPencil } from '../../icons/HygoIcons';
								...
								<View>
									...
									<View style={{ backgroundColor: COLORS.DARK_BLUE, paddingTop: 10 }}>
										...
										<View style={styles.hoursView}>
											<TouchableOpacity onPress={() => setShowPickerMin(true)} style={hygoStyles.editBox}>
												<Text style={styles.hourTitle}>{context.selectedSlot.min}h</Text>
												<HygoIconsPencil style={{marginLeft: 5}}/>
											</TouchableOpacity>
											<TouchableOpacity style={styles.hoursButton}>
												<Text style={styles.hourTitle}>-</Text>
											</TouchableOpacity>
											<TouchableOpacity onPress={() => setShowPickerMax(true)} style={hygoStyles.editBox}>
